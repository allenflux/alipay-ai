...
def convert_labelme_to_coco(labels_dir: Path, images_dir: Path, output_path: Path) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> None:
    ...
    coco = convert_labelme_to_coco(args.labels, args.images, args.output)
